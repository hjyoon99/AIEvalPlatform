...
> Wiki 권장 경로: `Project-Overview`

## 프로젝트 한 줄 소개

**AIEvalPlatform은 AI 에이전트의 답변을 프로젝트별 정책과 테스트 시나리오에 따라 생성·검증·평가하고, 그 판단 근거와 실행 이력을 관리하는 로컬 AI 품질 평가 플랫폼이다.**
...
- [전체 시스템 구조](./System-Architecture.md)
- [데이터 파이프라인 및 흐름](./Data-Pipeline.md)
- [AI 평가 엔진 설계](./AI-Evaluation-Engine.md)
- [API 명세서](./API-Reference.md)
- [데이터베이스 ERD](./Database-Schema.md)
- [설치 및 실행 방법](../README.md)
